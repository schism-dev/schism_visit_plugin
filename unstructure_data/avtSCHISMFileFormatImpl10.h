...
class avtSCHISMFileFormatImpl10 : public FileFormatFavorInterface {
  public:
    ...
    vtkDataArray* GetVar(int a_timeState, const char* a_varName);

    vtkDataArray* GetVectorVar(int a_timeState, const char* a_varName);
  ...
  protected:
    ...
    SCHISMFile10*
        m_data_file_ptr2; // in scribe format, vector another component
